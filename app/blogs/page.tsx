          ...
          <Bounded
            key={item.id}
              ...
              >
                    ...
                    <div className="relative flex h-screen flex-col justify-center">
                      <div className="bg-logocolor p-4"> 
                    <RevealText
                  ...
                  <Link href={`/blog/${item.uid}`} className="w-full text-center text-2xl border-2  border-gray-500 bg-logocolor py-5 hover:bg-logohovercolor" >More <FaChevronRight className="text-2xl ml-3 inline-block"/></Link>
