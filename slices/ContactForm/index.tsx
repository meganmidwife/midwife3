...
const ContactForm = ({ slice }: ContactFormProps): JSX.Element => {
  ...
  return (
    ...
    >
      <div id="contactform">
      <div className="glow absolute -z-10 aspect-square rounded-full bg-blue-400/20 blur-3xl filter" />
  
     <div className="mt-16 grid items-center gap-4  border border-blue-50/20 bg-gradient-to-b from-slate-50/15 to-slate-50/5  backdrop-blur-sm lg:grid-cols-2 lg:gap-0 lg:py-5">
        ...
        <form className="m-3">
          <div className="email grid grid-cols-3 align-middle items-center border-b-2 border-gray-500">
            ...
            <input 
              ...
              placeholder="email"
              required
              className="col-span-3 md:col-span-2  text-gray-900 bg-gray-300 py-2 px-2 mb-3 md:mb-0"
              value={email}
              onChange={(e)=>setEmail(e.target.value)}
              />
          </div>
          <div className="phone grid grid-cols-3 align-middle items-center border-b-2 border-gray-500">
            <label htmlFor="frm-phone" className="col-span-3 md:col-span-1 text-gray-900  text-center font-bold py-2 w-full  md:text-left border-2 border-gray-200  bg-logocolor md:m-3 pl-1 md:pl-4 pr-1 md:pr-3 md:border-0 md:bg-logocolor">Phone</label>
            <input 
              type="phone" 
              id="frm-phone" 
              name="frm-phone"
          ...
          <div className="first-name grid grid-cols-3 align-middle items-center border-b-2 border-gray-500">
            <label htmlFor="frm-first-name" className="col-span-3 md:col-span-1 text-gray-900 text-center font-bold py-2 w-full  md:text-left border-2 border-gray-200 bg-logocolor md:m-3 pl-1 md:pl-4 pr-1 md:pr-3 md:border-0 md:bg-logocolor">First Name </label>
            <input 
              type="first-name" 
              id="frm-first-name" 
              name="frm-first-name"
          ...
          <div className="last-name grid grid-cols-3 align-middle items-center border-b-2 mb-2 border-gray-500">
            <label htmlFor="frm-last-name" className="col-span-3 md:col-span-1 text-gray-900 text-center font-bold py-2 w-full  md:text-left border-2 border-gray-200  bg-logocolor md:m-3  pl-1 md:pl-4 pr-1 md:pr-3 md:border-0 md:bg-logocolor">Last Name</label>
            <input 
              type="last-name" 
              id="frm-last-name" 
              name="frm-last-name"
      ...
      <div className="last-name grid grid-cols-3 align-middle items-center">
        <label htmlFor="frm-message" className="col-span-3  pl-1 pt-3 md:pt-0 md:pl-4 h-full pr-1 md:pr-3 md:col-span-1 text-gray-900 font-bold py-2 text-center w-full  md:text-left border-2 border-gray-200  bg-logocolor md:m-3 md:border-0 md:bg-logocolor">Message</label>
